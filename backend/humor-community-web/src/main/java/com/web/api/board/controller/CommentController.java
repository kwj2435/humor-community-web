...
public class CommentController {
    ...
    public ResponseEntity<Map<String, Integer>> deleteComment(@PathVariable("commentIdx") Integer commentIdx)
            throws Exception {
    ...
    public ResponseEntity<CommentInfo> updateComment(
            @ApiParam(value = "댓글 Idx 값") @PathVariable("commentIdx") Integer commentIdx,
            @ApiParam(value = "Json형태 댓글내용(CommentContent)") @RequestBody Map<String, String> comment) {
